...
export default class qsrcParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by qsrcParser#close.
	visitClose(ctx) {
	  return this.visitChildren(ctx);
	}
